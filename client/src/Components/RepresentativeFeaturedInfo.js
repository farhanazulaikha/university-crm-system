...
function RepresentativeFeaturedInfo() {
    ...
    useEffect(()=>{
        ...
        Axios.get(`http://localhost:3001/${userId}/totalproject2`,{
            id: userId,
    })
        .then((res) => {
    ...
    useEffect(()=>{
        ...
        Axios.get(`http://localhost:3001/${userId}/pendingrep`,{
            id: userId,
    })
        .then((res) => {
...
export default RepresentativeFeaturedInfo